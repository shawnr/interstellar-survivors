...
BonusItemsData = {
    ...
    alloy_gears = {
        ...
        iconPath = "images/icons_on_black/bonus_alloy_gears",
    ...
    expanded_dish = {
        ...
        iconPath = "images/icons_on_black/bonus_expanded_dish",
    ...
    magnetic_coils = {
        ...
        iconPath = "images/icons_on_black/bonus_magnetic_coils",
    ...
    cooling_vents = {
        ...
        iconPath = "images/icons_on_black/bonus_cooling_vents",
    ...
    compressor_unit = {
        ...
        iconPath = "images/icons_on_black/bonus_compressor_unit",
    ...
    capacitor_bank = {
        ...
        iconPath = "images/icons_on_black/bonus_capacitor_bank",
    ...
    probe_swarm = {
        ...
        iconPath = "images/icons_on_black/bonus_probe_swarm",
        effect = "extra_probes",
        effectValue = 2,
    ...
    field_amplifier = {
        ...
        iconPath = "images/icons_on_black/bonus_field_amplifier",
        effect = "push_force",
        effectValue = 0.5,
    ...
    reinforced_hull = {
        ...
        iconPath = "images/icons_on_black/bonus_reinforced_hull",
        effect = "max_health",
        effectValue = 0.2,
        pairsWithTool = nil,
        unlockCondition = "start",
    ...
    emergency_thrusters = {
        ...
        iconPath = "images/icons_on_black/bonus_emergency_thrusters",
    ...
    overclocked_capacitors = {
        ...
        iconPath = "images/icons_on_black/bonus_overclocked_caps",
        effect = "fire_rate",
        effectValue = 0.15,
        pairsWithTool = nil,
        unlockCondition = "episode_1",
    ...
    rapid_repair = {
        ...
        iconPath = "images/icons_on_black/bonus_extended_sensors",  -- Reuse icon
        effect = "regen_speed",
    ...
    scrap_collector = {
        ...
        iconPath = "images/icons_on_black/bonus_scrap_collector",
        effect = "rp_bonus",
        effectValue = 0.15,
        pairsWithTool = nil,
        unlockCondition = "episode_3",
    ...
    backup_generator = {
        ...
        iconPath = "images/icons_on_black/bonus_backup_generator",
        effect = "health_regen",
    ...
    ablative_coating = {
        ...
        iconPath = "images/icons_on_black/bonus_ablative_coating",
    ...
    shield_capacitor = {
        ...
        iconPath = "images/icons_on_black/bonus_shield_capacitor",
    ...
    quantum_stabilizer = {
        ...
        iconPath = "images/icons_on_black/bonus_quantum_stabilizer",
    ...
    power_relay = {
        ...
        name = "Power Relay",
        description = "+10% all damage",
        iconPath = "images/icons_on_black/bonus_power_relay",
        effect = "damage_boost",
        effectValue = 0.1,
        pairsWithTool = nil,
        unlockCondition = "episode_1",
    ...
    targeting_matrix = {
        ...
        iconPath = "images/icons_on_black/bonus_targeting_matrix",
    ...
    -- BrainBuddy - neuro-implant augmentation for improved reflexes
    brain_buddy = {
        id = "brain_buddy",
        name = "BrainBuddy",
        description = "+15% fire rate",
        iconPath = "images/icons_on_black/bonus_brain_buddy",
        effect = "fire_rate",
        effectValue = 0.15,
        pairsWithTool = nil,
        unlockCondition = "episode_3",
        effectPerLevel = 0.08,  -- +8% fire rate per level
    },
    ...
    graviton_lens = {
        ...
        iconPath = "images/icons_on_black/bonus_graviton_lens",
    ...
    fuel_injector = {
        ...
        iconPath = "images/icons_on_black/bonus_fuel_injector",
    ...
    arc_capacitors = {
        ...
        iconPath = "images/icons_on_black/bonus_arc_capacitors",
    ...
    phase_modulators = {
        ...
        iconPath = "images/icons_on_black/bonus_phase_modulators",
        effect = "damage_phase",
        effectValue = 0.25,
    ...
    critical_matrix = {
        ...
        iconPath = "images/icons_on_black/bonus_critical_matrix",
        effect = "crit_chance",
        effectValue = 0.15,
        pairsWithTool = nil,
        unlockCondition = "episode_2",
    ...
    salvage_drone = {
        ...
        iconPath = "images/icons_on_black/bonus_salvage_drone",
        effect = "auto_collect",
    ...
    kinetic_absorber = {
        ...
        iconPath = "images/icons_on_black/bonus_kinetic_absorber",
        effect = "hp_on_kill",
    ...
    rapid_loader = {
        ...
        iconPath = "images/icons_on_black/bonus_rapid_loader",
    ...
    multi_spectrum_rounds = {
        ...
        iconPath = "images/icons_on_black/bonus_multi_spectrum_rounds",
